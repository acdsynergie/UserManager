...
This will create an executable jar file **UserManager-wildfly.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/UserManager-wildfly.jar -Djboss.socket.binding.port-offset=100
